...
for (let i = 0; i < NODE_COUNT; i++) {
  ...
  const nodeIp = `10.10.${i + 1}.0`;
  const dindIp = `10.10.${i + 1}.1`;
  ...
  w('      # Services');
  w('      FLUX_DAEMON_HOST: "10.10.0.3"');
  w('      FLUX_BENCH_HOST: "10.10.0.3"');
  w('      FLUX_SYNCTHING_HOST: "10.10.0.4"');
  w('      # Node identity');

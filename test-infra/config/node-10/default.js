...
module.exports = {
  ...
  database: {
    ...
    "appslocal": {
        "database": "node10_localzelapps",
        "collections": {
            "appsInformation": "zelappsinformation"
        }
    },
    "appsglobal": {
        "database": "node10_globalzelapps",
        "collections": {
    ...
    "chainparams": {
        "database": "node10_chainparams",
        "collections": {
            "chainMessages": "chainmessages"
        }
    },
    "fluxshare": {
        "database": "node10_zelshare",
        "collections": {
            "shared": "shared"
        }
    }

...
module.exports = {
  ...
  database: {
    ...
    "appslocal": {
        "database": "node09_localzelapps",
        "collections": {
            "appsInformation": "zelappsinformation"
        }
    },
    "appsglobal": {
        "database": "node09_globalzelapps",
        "collections": {
    ...
    "chainparams": {
        "database": "node09_chainparams",
        "collections": {
            "chainMessages": "chainmessages"
        }
    },
    "fluxshare": {
        "database": "node09_zelshare",
        "collections": {
            "shared": "shared"
        }
    }

...
module.exports = {
  ...
  database: {
    ...
    "appslocal": {
        "database": "node01_localzelapps",
        "collections": {
            "appsInformation": "zelappsinformation"
        }
    },
    "appsglobal": {
        "database": "node01_globalzelapps",
        "collections": {
    ...
    "chainparams": {
        "database": "node01_chainparams",
        "collections": {
            "chainMessages": "chainmessages"
        }
    },
    "fluxshare": {
        "database": "node01_zelshare",
        "collections": {
            "shared": "shared"
        }
    }

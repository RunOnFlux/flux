...
describe('fileQueryService tests', () => {
  ...
  describe('getAppsFolder tests', () => {
    it('should return folder contents when authorized', async () => {
      ...
      lstatStub.withArgs('/mnt/appvolumes/TestApp_Component1/appdata//file1.txt').resolves({
        isDirectory: () => false,
        isFile: () => true,
      ...
      lstatStub.withArgs('/mnt/appvolumes/TestApp_Component1/appdata//file2.txt').resolves({
        isDirectory: () => false,
        isFile: () => true,
        isSymbolicLink: () => false,
        size: 2048,
      ...
      lstatStub.withArgs('/mnt/appvolumes/TestApp_Component1/appdata//folder1').resolves({
        isDirectory: () => true,
        isFile: () => false,
        isSymbolicLink: () => false,
        size: 4096,
    ...
    it('should handle subfolder path correctly', async () => {
      ...
      sinon.assert.calledWith(readdirStub, '/mnt/appvolumes/TestApp_Component1/appdata/data/logs');
    });

  ...
  describe('setupUPNP tests', () => {
    ...
    it('should return true if all client responses are valid', async () => {
      ...
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 123, private: 123, ttl: 2700, description: 'Flux_Backend_API',
      });
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 122, private: 122, ttl: 2700, description: 'Flux_Home_UI',
      });
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 125, private: 125, ttl: 2700, description: 'Flux_Syncthing',
      });
    });
    ...
    it('should return true if all client responses are valid, no parameter passed', async () => {
      ...
      sinon.assert.calledThrice(createMappingSpy);
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 5550, private: 5550, ttl: 2700, description: 'Flux_Backend_API',
      });
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 5549, private: 5549, ttl: 2700, description: 'Flux_Home_UI',
      });
      sinon.assert.calledWithExactly(createMappingSpy, {
        public: 5552, private: 5552, ttl: 2700, description: 'Flux_Syncthing',
      });
    });

...
module.exports = (app, expressWs) => {
  ...
  app.get('/flux/incomingconnections', cache('30 seconds'), (req, res) => {
    zelfluxCommunication.getIncomingConnections(req, res, expressWs.getWss('/ws/flux'));
  });
  app.get('/flux/incomingconnectionsinfo', cache('30 seconds'), (req, res) => {
    zelfluxCommunication.getIncomingConnectionsInfo(req, res, expressWs.getWss('/ws/flux'));
  });
  ...
  app.get('/flux/removeincomingpeer/:ip?', (req, res) => {
    zelfluxCommunication.removeIncomingPeer(req, res, expressWs.getWss('/ws/flux'));
  });
  ...
  app.ws('/ws/flux', (ws, req) => {
    zelfluxCommunication.handleIncomingConnection(ws, req, expressWs.getWss('/ws/flux'));
  });

...
module.exports = (app, expressWs) => {
  // GET PUBLIC methods
  app.get('/zelcash/help/:command?', cache('1 hour'), (req, res) => {
    // accept both help/command and ?command=getinfo. If
  ...
  app.get(
    '/zelcash/decodezelnodebroadcast/:hexstring?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getzelnodescores/:blocks?',
    cache('30 seconds'),
    (req, res) => {
      // defaults to 10
  ...
  app.get(
    '/zelcash/getzelnodewinners/:blocks?/:filter?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/relayzelnodebroadcast/:hexstring?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getblock/:hashheight?/:verbosity?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getblockheader/:hash?/:verbose?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/gettxout/:txid?/:n?/:includemempool?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/gettxoutproof/:txids?/:blockhash?',
    cache('30 seconds'),
    (req, res) => {
      // comma separated list of txids. For example:
  ...
  app.get(
    '/zelcash/verifytxoutproof/:proof?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getblocksubsidy/:height?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getblocktemplate/:jsonrequestobject?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getnetworkhashps/:blocks?/:height?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getnetworksolps/:blocks?/:height?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/decoderawtransaction/:hexstring?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/sendrawtransaction/:hexstring?/:allowhighfees?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/estimatepriority/:nblocks?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/validateaddress/:zelcashaddress?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/verifymessage/:zelcashaddress?/:signature?/:message?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/gettransaction/:txid?/:includewatchonly?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/zvalidateaddress/:zaddr?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelapps/installedzelapps/:appname?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelapps/registrationinformation',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.post('/zelapps/calculateprice', (req, res) => {
    // returns price in zel for both new registration of
    // zelapp and update of zelapp
    zelappsService.getAppPrice(req, res);
  });
  app.get(
    '/zelapps/whitelistedrepositories',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/prioritisetransaction/:txid?/:prioritydelta?/:feedelta?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/submitblock/:hexdata?/:jsonparametersobject?',
    cache('30 seconds'),
    (req, res) => {
  ...
  app.get(
    '/zelcash/getreceivedbyaddress/:zelcashaddress?/:minconf?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/importprivkey/:zelcashprivkey?/:label?/:rescan?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/listtransactions/:count?/:from?/:includewatchonly?',
    (req, res) => {
      zelcashService.listTransactions(req, res);
    }
  );
  app.get(
    '/zelcash/listunspent/:minconf?/:maxconf?/:addresses?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/zgettotalbalance/:minconf?/:includewatchonly?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/zimportviewingkey/:vkey?/:rescan?/:startheight?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/zsendmany/:fromaddress?/:amounts?/:minconf?/:fee?',
    (req, res) => {
  ...
  app.get(
    '/zelcash/zshieldcoinbase/:fromaddress?/:toaddress?/:fee?/:limit?',
    (req, res) => {
  ...
  app.get('/zelflux/adjustcruxid/:cruxid?', (req, res) => {
    // note this essentially rebuilds flux use with caution!
    zelnodeService.adjustCruxID(req, res);
  });
  app.get('/zelflux/adjustkadena/:account?/:chainid?', (req, res) => {
    // note this essentially rebuilds flux use with caution!
  ...
  app.get('/zelcash/ping', (req, res) => {
    // we do not want this to be issued by anyone.
  ...
  app.get('/zelnode/updatezelflux', (req, res) => {
    // method shall be called only if zelflux version is obsolete.
    zelnodeService.updateZelFlux(req, res);
  });
  app.get('/zelnode/hardupdatezelflux', (req, res) => {
    // method shall be called only if zelflux version is
  ...
  app.get('/zelnode/updatezelcash', (req, res) => {
    // method shall be called only if zelcash version is obsolete
    zelnodeService.updateZelCash(req, res);
  });
  app.get('/zelnode/updatezelbench', (req, res) => {
    // method shall be called only if zelbench version is obsolete
  ...
  app.get('/zelflux/removeincomingpeer/:ip?', (req, res) => {
    zelfluxCommunication.removeIncomingPeer(
      req,
      res,
      expressWs.getWss('/ws/zelflux')
    );
  ...
  app.get(
    '/zelapps/installtemporarylocalapp/KadenaChainWebNode',
    (req, res) => {
  ...
  app.post('/zelid/logoutspecificsession', (req, res) => {
    // requires the knowledge of a session loginPhrase so

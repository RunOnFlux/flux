...
module.exports = (app, expressWs) => {
  // GET PUBLIC methods
  app.get('/zelcash/help/:command?', (req, res) => {
  ...
  app.get('/zelcash/getzelnodescores/:blocks?', (req, res) => {
    // defaults to 10
  ...
  app.get('/zelcash/gettxoutproof/:txids?/:blockhash?', (req, res) => {
  ...
  app.get(
    ...
    (req, res) => {
      // privacy level means restrictions of calls. envvars can
      // have privacy to be/not to be exposed // TODO make me
      // post, needs redoing
      zelappsService.zelAppRegister(req, res);
    }
  );
  app.get('/zelapps/zelapppull/:repotag?', (req, res) => {
    // TODO make me post, needs redoing
  ...
  app.get('/zelapps/zelappinspect/:container?', (req, res) => {
    // TODO this shall require app owner privilege for all
    // information
    zelappsService.zelAppInspect(req, res);
  });
  app.get('/zelapps/zelappupdate/:container?/:cpus?/:memory?', (req, res) => {
    // TODO this shall require app owner privilege for all
    // information
    zelappsService.zelAppUpdate(req, res);
  });
  app.get('/zelapps/zelappexec/:container?/:cmd?/:env?', (req, res) => {
    // todo post, privileges

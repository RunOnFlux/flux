...
module.exports = (app, expressWs) => {
  ...
  app.get('/zelcash/decoderawtransaction/:hexstring?',
          (req, res) => { zelcashService.decodeRawTransaction(req, res); });
  app.get('/zelcash/decodescript/:hex?',
  ...
  app.get('/zelcash/estimatefee/:nblocks?',
          (req, res) => { zelcashService.estimateFee(req, res); });
  app.get('/zelcash/estimatepriority/:nblocks?',
          (req, res) => { zelcashService.estimatePriority(req, res); });
  app.get('/zelcash/validateaddress/:zelcashaddress?',
  ...
  app.get('/zelcash/zvalidateaddress/:zaddr?',
          (req, res) => { zelcashService.zValidateAddress(req, res); });
  app.get('/zelcash/getbenchmarks',
          (req, res) => { zelcashService.getBenchmarks(req, res); });
  app.get('/zelcash/getbenchstatus',
  ...
  app.get('/zelid/loggedsessions',
          (req, res) => { zelidService.loggedSessions(req, res); });
  app.get('/zelid/logoutcurrentsession',
          (req, res) => { zelidService.logoutCurrentSession(req, res); });
  app.get('/zelid/logoutallsessions',
          (req, res) => { zelidService.logoutAllSessions(req, res); });

  app.get('/zelbench/getstatus',
          (req, res) => { zelbenchService.getStatus(req, res); });
  app.get('/zelbench/help', (req, res) => { zelbenchService.help(req, res); });
  app.get('/zelbench/getbenchmarks',
          (req, res) => { zelbenchService.getBenchmarks(req, res); });
  app.get('/zelbench/getinfo',
  ...
  app.get('/zelapps/zelapppull/:repotag?',
          (req, res) => { // TODO make me post, needs redoing
            zelappsService.zelAppPull(req, res);
          });
  app.get('/zelapps/zelappstart/:container?',
          (req, res) => { zelappsService.zelAppStart(req, res); });
  app.get('/zelapps/zelappstop/:container?',
          (req, res) => { zelappsService.zelAppStop(req, res); });
  app.get('/zelapps/restartzelapp/:container?',
          (req, res) => { zelappsService.zelAppRestart(req, res); });
  app.get('/zelapps/zelappkill/:container?',
          (req, res) => { zelappsService.zelAppKill(req, res); });
  app.get('/zelapps/zelappcontainerremove/:container?',
          (req, res) => { zelappsService.zelAppRemove(req, res); });
  app.get('/zelapps/zelapppause/:container?',
          (req, res) => { zelappsService.zelAppPause(req, res); });
  app.get('/zelapps/zelappunpause/:container?',
          (req, res) => { zelappsService.zelAppUnpause(req, res); });
  app.get('/zelapps/zelapptop/:container?',
          (req, res) => { zelappsService.zelAppTop(req, res); });
  app.get('/zelapps/zelapplog/:container?',
          (req, res) => { zelappsService.zelAppLog(req, res); });
  app.get('/zelapps/zelappinspect/:container?',
          (req, res) => { // TODO this shall require app owner privilege for all
                          // information
            zelappsService.zelAppInspect(req, res);
          });
  app.get('/zelapps/zelappupdate/:container?/:cpus?/:memory?',
          (req, res) => { // TODO this shall require app owner privilege for all
                          // information
            zelappsService.zelAppUpdate(req, res);
          });
  app.get('/zelapps/zelappexec/:container?/:cmd?/:env?',
          (req, res) => { // todo post, privileges
            zelappsService.zelAppExec(req, res);
          });
  app.get('/zelapps/zelappremove/:zelapp?',
          (req, res) => { zelappsService.removeZelAppLocallyApi(req, res); });
  app.get('/zelapps/zelappimageremove/:image?',
          (req, res) => { zelappsService.zelAppImageRemove(req, res); });
  app.get('/zelapps/zelapptemporarylocalregister/zelFoldingAtHome', (req,
                                                                     res) => {
  ...
  app.get(
      '/zelapps/resacnglobalappsinformation/:blockheight?/:removelastinformation?',
      (req, res) => { // todo post, privileges
        zelappsService.rescanGlobalAppsInformationAPI(req, res);
      });
  app.get('/zelapps/reindexglobalappsinformation',
          (req, res) => { // todo post, privileges
            zelappsService.reindexGlobalAppsInformationAPI(req, res);
          });
  app.get('/zelapps/reindexglobalappslocation',
          (req, res) => { // todo post, privileges

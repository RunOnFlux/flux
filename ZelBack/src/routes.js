...
module.exports = (app, expressWs) => {
  ...
  app.get('/zelflux/zelid', cache('30 seconds'),
  ...
  app.get('/zelflux/kadena', cache('30 seconds'),
          (req, res) => { zelnodeService.getZelFluxKadena(req, res); });
  ...
  app.get('/zelnode/zelfluxwarnlog',
          (req, res) => { zelnodeService.zelfluxWarnLog(req, res); });
  app.get('/zelnode/zelfluxdebuglog',
          (req, res) => { zelnodeService.zelfluxDebugLog(req, res); });
  app.get('/zelnode/zelfluxinfolog',
          (req, res) => { zelnodeService.zelfluxInfoLog(req, res); });
  app.get('/zelnode/tailzelfluxerrorlog',
          (req, res) => { zelnodeService.tailFluxErrorLog(req, res); });
  app.get('/zelnode/tailzelfluxwarnlog',
          (req, res) => { zelnodeService.tailFluxWarnLog(req, res); });
  app.get('/zelnode/tailzelfluxdebuglog',
          (req, res) => { zelnodeService.tailFluxDebugLog(req, res); });
  app.get('/zelnode/tailzelfluxinfolog',
          (req, res) => { zelnodeService.tailFluxInfoLog(req, res); });
  ...
  app.get('/zelapps/zelshare/getfile/:file?/:token?',
          (req, res) => { zelappsService.zelShareDownloadFile(req, res); });
  ...
  app.get('/zelapps/zelshare/rename/:oldpath?/:newname?',
          (req, res) => { zelappsService.zelShareRename(req, res); });
  app.get('/zelapps/zelshare/downloadfolder/:folder?',
          (req, res) => { zelappsService.zelShareDownloadFolder(req, res); });
};

...
async function startFluxFunctions() {
  try {
    ...
    await databaseTemp.collection(config.database.appsglobal.collections.appsInstallingErrorsLocations).createIndex({ broadcastedAt: 1 }, { expireAfterSeconds: installErrorTtlS });

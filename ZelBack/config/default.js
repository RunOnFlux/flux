module.exports = {
  ...
  database : {
    ...
    zelappsglobal : {
      ...
      collections : {
        ...
        zelappsInformation :
            'zelappsinformation', // stores actual state of zelapp configuration
                                  // info - initial state and its overwrites
                                  // with update messages
        zelappsTemporaryMessages :
            'zelappstemporarymessages', // storages for all zelapps messages
                                        // that are not yet confirmed on the
                                        // zelcash network
        zelappsLocations :
            'zelappslocation', // stores location of zelapps as documents
  ...
  zelapps : {
    ...
    address :
        't1Pb6GxM85aHEtUjp226ZmfcZJ4rtcjbtiA', // apps registration address
    epochstart : 645700, // zelapps epoch blockheight start
    portMin : 31000,     // originally should have been from 30000 but we got
                         // temporary folding there
    portMax : 39999,
    ...
    blocksLasting : 22000, // registered app will live for 22000 of blocks 44000
                           // minutes ~= 1 month
    // every 100 blocks we run a check that deletes apps specifications and
    // stops/removes the application from existence if it has been lastly
    // updated more than 22k blocks ago
  },
